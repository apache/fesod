...
public class SqlDateStringConverter implements Converter<Date> {
    ...
    public Date convertToJavaData(
        ...
        return Date.valueOf(DateUtils.parseLocalDate(
                dateString, contentProperty.getDateTimeFormatProperty().getFormat(), null));
    }
    ...
    public WriteCellData<?> convertToExcelData(
        ...
        return new WriteCellData<>(DateUtils.format(
                value.toLocalDate(), contentProperty.getDateTimeFormatProperty().getFormat()));
    }
}
