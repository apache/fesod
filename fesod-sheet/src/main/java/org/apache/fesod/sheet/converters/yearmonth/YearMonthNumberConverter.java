 ...
 *
 * <p>A month is read from and written to the first day of that month, so the value stays a real date in the sheet.
 *
 */
public class YearMonthNumberConverter implements Converter<YearMonth> {
    ...
    public WriteCellData<?> convertToExcelData(
        ...
        return new WriteCellData<>(BigDecimal.valueOf(DateUtil.getExcelDate(
                value.atDay(1).atStartOfDay(), DateUtils.isDate1904(contentProperty, globalConfiguration))));
    }
}
