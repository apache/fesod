...
public class YearMonthStringConverter implements Converter<YearMonth> {
    ...
    public YearMonth convertToJavaData(
        ...
        if (contentProperty == null || contentProperty.getDateTimeFormatProperty() == null) {
            return YearMonth.parse(stringValue, DateTimeFormatter.ofPattern(YearMonthDateConverter.DEFAULT_FORMAT));
        }
    ...
    public WriteCellData<?> convertToExcelData(
        ...
        if (contentProperty == null || contentProperty.getDateTimeFormatProperty() == null) {
            return new WriteCellData<>(
                    value.format(DateTimeFormatter.ofPattern(YearMonthDateConverter.DEFAULT_FORMAT)));
        }
        return new WriteCellData<>(value.format(DateTimeFormatter.ofPattern(
                contentProperty.getDateTimeFormatProperty().getFormat())));
    }
}
