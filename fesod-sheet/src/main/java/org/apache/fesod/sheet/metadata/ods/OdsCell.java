...
/**
 * ODS cell implementation for writing ODS files.
 *
 */
@Getter
@Setter
@EqualsAndHashCode
public class OdsCell extends CellBase {
    ...
    public OdsCell(OdsWorkbook odsWorkbook, OdsSheet odsSheet, OdsRow odsRow, Integer columnIndex, CellType cellType) {
    ...
    public int getRowIndex() {
        return odsRow.getRowNum();
    }

    @Override
    public Sheet getSheet() {
        return odsRow.getSheet();
    }
